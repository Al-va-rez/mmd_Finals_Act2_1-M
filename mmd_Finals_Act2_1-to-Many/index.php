    ...
    <body>
        <main>
            ...
            <div class="flex flex-row flex-nowrap justify-evenly">
                ...
                <!-- ADD CUSTOMER -->
                <div class="bg-white border rounded-lg shadow-lg p-6 w-[30%] h-[55vh]">
                ...
                <!-- VIEW ALL CUSTOMERS -->
                    <div class="flex flex-col bg-white border rounded-lg shadow-lg p-6 w-[60%] h-[55vh]">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 text-sm text-left">
                        ...
                        <tbody>
                            <?php foreach ($ordersData as $order) { ?>
                                <tr class="orderRow cursor-pointer hover:bg-gray-50" data-customer-id="<?= $order['customer_id']; ?>">
