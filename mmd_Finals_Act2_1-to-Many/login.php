    ...
    <body>
        <main>
            ...
            <div id="login" class="fixed inset-0 bg-white bg-opacity-100 flex flex-col items-center justify-center z-50 p-8">
                ...
                <div id="formContainer" class="bg-white border rounded-lg shadow-lg p-6 w-[40%] max-h-[80vh] overflow-y-auto">

                    <h2 class="text-3xl font-bold text-center">Login</h2>

                    <form id="loginForm" action="core/handleForms.php" method="POST" class="mt-12 space-y-10">
